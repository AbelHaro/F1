...
const URL_DRIVER = `${URL}/drivers/names/`;
...
export function IndividualDriver() {
  ...
  return (
    <div className="driver-container">
      <div className="info-container">{personalInfo}</div>
      <div className="info-container">{stats1}</div>
      <div className="info-container">{stats2}</div>
    </div>
  );
}
